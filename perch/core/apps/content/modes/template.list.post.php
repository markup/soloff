...
?>
            <tr>
                <td><a href="<?php echo PerchUtil::html(PERCH_LOGINPATH); ?>/core/apps/content/page/templates/edit/?id=<?php echo PerchUtil::html(urlencode($Template->id())); ?>"><?php echo PerchUtil::html($Template->templateTitle())?></a></td>
