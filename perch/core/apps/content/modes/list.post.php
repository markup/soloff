...
<p><?php echo PerchLang::get('This page shows you the pages of your site. If any page has a new Perch region on it that has not yet been configured you will see NEW in the Type column for that page.'); ?></p>
...
<?php include ('_subnav.php'); ?>
	...
	<ul class="smartbar">
        <li><span class="set">Filter</span></li>
        <li class="<?php echo ($filter=='all'?'selected':''); ?>"><a href="<?php echo PerchUtil::html(PERCH_LOGINPATH.'/core/apps/content/'); ?>">All</a></li>
        <li class="new <?php echo ($filter=='new'?'selected':''); ?>"><a href="<?php echo PerchUtil::html(PERCH_LOGINPATH.'/core/apps/content/?filter=new'); ?>">New</a></li>
		<?php
    ...
    ?>
        ...
        <?php if ($filter == 'all') { ?>
            <p class="alert filter"><?php echo PerchLang::get('No content yet?'); ?> <?php echo PerchLang::get('Make sure you have added some Perch regions into your page, and then visited that page in your browser. Once you have, the regions should show up here.'); ?>
