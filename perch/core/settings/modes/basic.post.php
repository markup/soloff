<?php include (PERCH_PATH.'/core/inc/sidebar_start.php'); ?>
    ...
    <p><?php echo PerchLang::get('These settings give you control over the editing environment. By default Perch will display regions in a single page editing mode, this can then be changed in the region setting per region if list/detail is more effective for that region. You can also choose whether the content list should be collapsed or not.'); ?></p>
